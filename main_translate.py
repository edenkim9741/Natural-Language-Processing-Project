...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="Dataset/full_tokenized_dataset_trans", help="Path to the tokenized dataset")
    parser.add_argument("--full_path", type=str, default="Dataset/merged_dataset.csv", help="Path to the full dataset for tokenization")
